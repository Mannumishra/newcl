          ...
          <div className="row desktopHeaderTop align-items-center">
            ...
            <div className="col-md-6 text-center">
              <marquee
                ...
                direction=""
              >
                RGDT TRADERS PRIVATE LIMITED - The trusted name in rice wholesale and dry fruits supply. Delivering premium quality products with excellence and reliability.
              </marquee>
          ...
          <div className="row align-items-center header-row">
            <div className="col-md-4 col-6">
              <Link to={"/"} style={{ textDecoration: "none" }}>
                <h5 style={{ color: "#FF6347", fontWeight: "700" }}>RGDT TRADERS PRIVATE LIMITED</h5>
              </Link>
            </div>

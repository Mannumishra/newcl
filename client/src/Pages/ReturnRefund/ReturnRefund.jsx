...
const ReturnRefund = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Return & Refund Policy - Panchgavya | RGDT TRADERS PRIVATE LIMITED</title>
        <meta
          name="description"
      ...
      <section className="return-refund-section">
        <div className="container">
          ...
          <div className="section-intro">
            <p>
              At <strong> RGDT TRADERS PRIVATE LIMITED</strong>, we are committed to
          ...
          <div className="policy-section">
            ...
            <p>
              ...
              <a href="mailto:support@rgdttraders.com" className="highlight">
                {" "}
                support@rgdttraders.com
              </a>
              with:
            </p>
            <ul>

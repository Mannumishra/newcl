...
const DeliveryInformation = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Delivery Information | RGDT TRADERS PRIVATE LIMITED</title> {/* Page title */}
        <meta
          name="description"
          content="Find all the details about our delivery process, timelines, shipping charges, and delivery areas at RGDT TRADERS PRIVATE LIMITED. Get timely and efficient delivery of your orders."
        />
        <meta
          name="keywords"
          content="delivery information, shipping charges, delivery process, shipping policy, RGDT TRADERS PRIVATE LIMITED"
        />
      ...
      <section class="delivery-section">
        <div class="container">
          ...
          <p>
            At RGDT TRADERS PRIVATE LIMITED, we take pride in delivering your
            orders in a timely and efficient manner. Below you will find all the
            essential details about our delivery process and policies.
          </p>

...
const Contact = () => {
  ...
  const postData = async (e) => {
    e.preventDefault()
    try {
      const res = await axios.post("https://induserver.assortsmachinetools.com/api/send-enquery", data)
      if (res.status === 200) {
        Swal.fire({
          title: 'Success!',
              ...
              <div className="row">
                ...
                <div className="col-12 mb-4">
                  <div className="contact-detail-card">
                    ...
                    <a href="tel:+91 9354757842" className="contact-link">
                      +91 9354757842
                    </a>
                  </div>
                </div>

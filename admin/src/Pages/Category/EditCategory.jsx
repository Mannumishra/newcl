...
const EditCategory = () => {
    ...
    useEffect(() => {
        ...
        const fetchCategory = async () => {
            try {
                const response = await axios.get(`https://induserver.assortsmachinetools.com/api/signle-category/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://induserver.assortsmachinetools.com/api/update-category/${id}`, formData, {
                headers: {

...
const AllCategory = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get('https://induserver.assortsmachinetools.com/api/all-category'); // Replace with your API endpoint
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                await axios.delete(`https://induserver.assortsmachinetools.com/api/delete-category/${id}`); // Replace with your API endpoint

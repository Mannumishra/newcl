...
const EditPincode = () => {
    ...
    useEffect(() => {
        ...
        const fetchPincodeDetails = async () => {
            try {
                const response = await axios.get(`https://induserver.assortsmachinetools.com/api/single-pincode/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://induserver.assortsmachinetools.com/api/update-pincode/${id}`, pincodeData);

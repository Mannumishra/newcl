...
const AllContactInquery = () => {
    ...
    useEffect(() => {
        const fetchContacts = async () => {
            try {
                const response = await axios.get('https://induserver.assortsmachinetools.com/api/all-contacts');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://induserver.assortsmachinetools.com/api/delete-contact/${id}`);

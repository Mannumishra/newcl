...
const AllBanner = () => {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
            setIsLoading(true);
            try {
                const response = await axios.get('https://induserver.assortsmachinetools.com/api/all-banner');
    ...
    const handleDelete = async (bannerId) => {
        try {
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://induserver.assortsmachinetools.com/api/banner/${bannerId}`);

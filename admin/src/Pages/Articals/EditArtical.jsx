...
const EditArtical = () => {
    ...
    useEffect(() => {
        const fetchArticalData = async () => {
            try {
                const response = await axios.get(`https://induserver.assortsmachinetools.com/api/single-artical/${id}`);
                setData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://induserver.assortsmachinetools.com/api/update-artical/${id}`, formData, {
                headers: {

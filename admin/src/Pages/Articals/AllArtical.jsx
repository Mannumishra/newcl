...
const AllArtical = () => {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            setIsLoading(true);
            try {
                const response = await axios.get('https://induserver.assortsmachinetools.com/api/all-articals');
    ...
    const handleDelete = async (articleId) => {
        try {
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://induserver.assortsmachinetools.com/api/delete-artical/${articleId}`);

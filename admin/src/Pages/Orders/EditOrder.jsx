    ...
    useEffect(() => {
        const fetchTaxDetails = async () => {
            ...
            for (const product of order.products) {
                try {
                    const response = await axios.get(`https://induserver.assortsmachinetools.com/api/single-product/${product.productId}`);
...
const EditOrder = () => {
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            try {
                const response = await axios.get(`https://induserver.assortsmachinetools.com/api/single-order-data/${orderId}`);
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.put(`https://induserver.assortsmachinetools.com/api/update-order/${orderId}`, {
                orderStatus,
                paymentStatus,
            });
            if (response.data.success) {

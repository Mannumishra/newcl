...
const EditSubCategory = () => {
    ...
    useEffect(() => {
        ...
        const fetchSubCategory = async () => {
            try {
                const response = await axios.get(`https://induserver.assortsmachinetools.com/api/single-subcategory/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://induserver.assortsmachinetools.com/api/update-subcategory/${id}`,
                apiFormData,
                {
                    headers: {

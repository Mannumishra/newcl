...
const AllVouchers = () => {
    ...
    useEffect(() => {
        const fetchVouchers = async () => {
            try {
                const response = await axios.get('https://induserver.assortsmachinetools.com/api/all-vouchers');
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://induserver.assortsmachinetools.com/api/delete-vouchers/${id}`);

...
const EditVouchers = () => {
    ...
    useEffect(() => {
        const fetchVoucher = async () => {
            try {
                const response = await axios.get(`https://induserver.assortsmachinetools.com/api/single-vouchers/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            await axios.put(`https://induserver.assortsmachinetools.com/api/update-vouchers/${id}`, voucherData);

...
const AllProduct = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('https://induserver.assortsmachinetools.com/api/get-product');
    ...
    const handleDelete = async (productId) => {
        try {
            ...
            if (result.isConfirmed) {
                const response = await axios.delete(`https://induserver.assortsmachinetools.com/api/delete-product/${productId}`);
    ...
    const handleStatusChange = async (productId, field, currentValue) => {
        try {
            const response = await axios.put(`https://induserver.assortsmachinetools.com/api/update-product/${productId}`, {

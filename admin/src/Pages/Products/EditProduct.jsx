...
const EditProduct = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get('https://induserver.assortsmachinetools.com/api/all-category');
        ...
        const fetchProduct = async () => {
            try {
                const response = await axios.get(`https://induserver.assortsmachinetools.com/api/single-product/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://induserver.assortsmachinetools.com/api/update-product/${id}`, formDataToSubmit, { headers: { 'Content-Type': 'multipart/form-data' } });
